// === STATE INTERFACE (Needs Completion) ===
interface State {
    // TODO: Declare the 5 methods for the state interface here:
    void insertCoin();
    void ejectCoin();
    void pressButton();
    void dispense();
...
// === CONTEXT CLASS (Fully Implemented) ===
class VendingMachine {
    // TODO: Declare the private fields here. You will need:
    ...
    // --- State Getters (Use these inside your concrete states!) ---
...
// === CONCRETE STATE 1: NO COIN (Needs Completion) ===
class NoCoinState implements State {
    ...
    public void insertCoin() {
        ...
        // TODO: Transition the machine to the HasCoinState
        System.out.println("Coin inserted.");
    ...
    @Override
    public void refill(int count) {
        // TODO: Add the count to the machine's inventory
...
// === CONCRETE STATE 2: HAS COIN (Needs Completion) ===
class HasCoinState implements State {
    ...
    public void ejectCoin() {
        ...
        // TODO: Transition the machine to the NoCoinState
        System.out.println("Coin returned.");
    ...
    public void pressButton() {
        ...
        // TODO: Transition the machine to the DispenseState
        System.out.println("Button pressed...");
...
// === CONCRETE STATE 3: DISPENSE (Needs Completion) ===
class DispenseState implements State {
    ...
    @Override
    public void dispense() {
        // TODO: Release the product from the machine
        

        // TODO: Check the machine's inventory. 
...
// === CONCRETE STATE 4: SOLD OUT (Needs Completion) ===
class SoldOutState implements State {
    ...
    @Override
    public void refill(int count) {
        // TODO: Add the count to the machine's inventory using machine.addInventory()
        machine.addInventory(count);

        System.out.println("Machine refilled. Total inventory: " + machine.getInventory());
        // TODO: Transition to NoCoinState
        machine.setState(machine.getNoCoinState());
